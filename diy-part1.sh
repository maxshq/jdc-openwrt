...
echo 'src-git luci https://github.com/Lienol/luci;21.02' >>feeds.conf.default
echo 'src-git packages https://github.com/Lienol/openwrt-packages' >>feeds.conf.default
