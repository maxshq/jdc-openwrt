...
echo 'src-git lienol-packages https://github.com/Lienol/openwrt-packages;main' >>feeds.conf.default
echo 'src-git kenzo https://github.com/kenzok8/openwrt-packages;master' >>feeds.conf.default
echo 'src-git lienol-luci https://github.com/Lienol/luci;21.02' >>feeds.conf.default
