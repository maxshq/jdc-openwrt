...
echo 'src-git luci https://github.com/Lienol/luci.git;21.02' >>feeds.conf.default
echo 'src-git packages https://github.com/Lienol/openwrt-packages.git' >>feeds.conf.default
